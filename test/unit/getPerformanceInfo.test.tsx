...
describe('get performance info', function () {
  it(`works correctly`, () => {
    ...
    const result = getPerformanceInfo({ samples: strData, fpsIsCapped: false, hiccupsInThousandFrames: 4, hiccupsTime: 2, totalTime: 100, estimatedAllocatedMemory: 0, estimatedTotalMemory: 0 })
