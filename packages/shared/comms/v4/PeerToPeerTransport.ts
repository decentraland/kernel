import { CommsEvents } from '../interface/index'
...
export class PeerToPeerTransport implements Transport {
  ...
  private initializePeer() {
    ...
    console.log("HERE", this.lighthouseUrl)
    this.peer = new Peer(this.lighthouseUrl, undefined, this.peerCallback, this.peerConfig)
    console.log("HEREP")
