...
import { Catalog, WearablesRequestFilters, WearableWithBaseUrl } from './types'
...
export const wearablesSuccess = (wearables: WearableWithBaseUrl[], context: string | undefined) =>
